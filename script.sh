  ...
  sudo apt install libssl-dev libelf-dev libncurses5-dev libncursesw5-dev musl-tools make -y

  # install qemu
  sudo apt install libpixman-1-dev libcairo2-dev libpango1.0-dev libjpeg8-dev libgif-dev ninja-build qemu -y
